...
import { useNewWebSocket } from '../            <div className="h-full flex flex-col">
...
const InputPage = ({ onReset }) => {
  ...
  const handleContentChange = (newContent) => {
    console.log('Content change received:', newContent)
  ...
  const handleLegacySettingsChange = (newSettings) => {
    if (typeof newSettings === 'function') {
      ...
      const newLayoutSettings = {
        ...
        marginLeft: updated.marginLeft || updated.margin || 20,
        marginRight: updated.marginRight || updated.margin || 20,
        fontFamily: layoutSettings.fontFamily,
        showReadingLine: updated.showReadingLine,
        readingLinePosition: updated.readingLinePosition
      }
      
      const newPlaybackState = {
        ...playbackState,
        speed: updated.scrollSpeed // Direct mapping 1-10
      }
      ...
      <div className="flex-shrink-0 bg-gray-900 border-b border-gray-700 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-semibold">Teleprompter Studio</h1>
          </div>
